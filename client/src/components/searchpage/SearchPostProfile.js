...
function SearchPostProfile({getProfileById,profile,auth,match}) {
    useEffect(() => {
...
export default connect(mapStateToProps, { getProfileById })(SearchPostProfile);
