...
export const Navbar = () => {
    return (
        <div className="div2">
            <div>
                <svg width="3em" height="3em" viewBox="0 0 16 16" class="bi bi-camera" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
                <Link to="/homepage/directs">
                <img className="direct" src={direct} alt="direct"></img>
                </Link>
            </div>
